...
-(void)loadWaveView
{
	...
	//振幅
	CGFloat waveCrests[4] = {maxY*0.2,maxY*0.15,maxY*0.17,maxY*0.11};
	CGFloat alphas[4] = {0.2f,0.15f,0.3f,0.25f};
	...
	for (int i = 0; i<3; i++) {
		...
		fillStyle.fillColor     = [DrawingColor colorWithUIColor:[color colorWithAlphaComponent:alphas[i]]];
		waveView.fillStyle      = fillStyle;
		DrawingStyle *strokeStyle = [DrawingStyle new];
		strokeStyle.strokeColor   = [DrawingColor colorWithUIColor:[color colorWithAlphaComponent:alphas[i]]];
